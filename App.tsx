...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const fetchRealtimeData = async () => {
      try {
        ...
        // ---- SAFE NORMALIZATION (backend sometimes sends empty objects) ----
  ...
  // ✅ Safely merge alerts (no crash if weather.alerts is undefined)
  ...
  return (
    <div className="flex flex-col h-screen bg-rail-dark text-white font-mono">
      ...
      <main className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-[450px] flex-shrink-0 bg-rail-mid border-l border-rail-light overflow-y-auto">
          <Dashboard
            trains={liveData.trains}
      ...
      <footer className="p-2 bg-rail-mid text-xs text-gray-500 border-t border-rail-light flex justify-between">
        <span className="text-rail-accent">© Created by Junoon</span>
        <span>Digesh Kumar Tandan – digeshtandan9212@gmail.com</span>
        <span>Harsh Kumar Sahani – harshkumarsahani22@gmail.com</span>
